...
// Editorial pull-quote layout with large typography.
// ============================================================
    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-8 lg:px-12">
        <div className="max-w-4xl">
          ...
          {/* Blue accent line */}
          <motion.div
            className="mt-4 h-px w-12 bg-[var(--sit-blue)]"
            initial={{ scaleX: 0 }}
          ...
          {/* Pull-quote style mission statement */}
          <motion.blockquote
          ...
          >
            <p className="text-2xl md:text-3xl lg:text-4xl font-light leading-snug text-white/90 tracking-tight">
              &ldquo;{siteConfig.mission.body}&rdquo;
            </p>
          </motion.blockquote>
        </div>
      </div>
